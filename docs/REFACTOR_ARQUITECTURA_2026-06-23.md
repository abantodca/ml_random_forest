...
> Se conserva porque lo citan `docs/adr/ADR-002` y `ADR-005` como la tabla de "qué se puede
> y qué no se puede mover" que fundamenta el contrato de nombres `step_XX_verbo/`. Las guías
> vigentes son `01-local.md`, `02-produccion-aws.md`, `03-arquitectura.md`,
> `04-guia-validacion-estadistica.md` y `05-auditoria-ml-2026-08-07.md`. Lo de abajo describe
> el estado del repo en junio de 2026 y **no** refleja el actual.
